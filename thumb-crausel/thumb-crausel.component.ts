...
declare var $ :any;
@Component({
  selector: 'app-thumb-crausel',
  templateUrl: './thumb-crausel.component.html',
  styleUrls: ['./thumb-crausel.component.css']
})
export class ThumbCrauselComponent implements OnInit {
  images=[
